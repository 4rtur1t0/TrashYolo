...
def inference(image_path, model, delay, conf=0.5):
...
if __name__ == '__main__':
    ...
    inference(image_path=image_path, model=model, delay=delay)

    image_path, model, delay = yolo_trash_on_people()
    inference(image_path=image_path, model=model, delay=delay)

    image_path, model, delay = yolo_trash_on_trash_train()
    inference(image_path=image_path, model=model,conf=0.4, delay=delay)
    ...
    inference(image_path=image_path, model=model, conf=0.2, delay=delay)
